...
Create an account at [dashboard.opendatalabs.com](https://dashboard.opendatalabs.com). Generate an API key and a data encryption secret under Settings, then store them as environment variables. Keep both values out of client-side code.
